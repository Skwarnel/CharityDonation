    ...
    class FormSteps {
        ...
        updateForm() {
            ...
            if (this.currentStep >= 5) {
                ...
                const institutionChecked = document.querySelector("[name=institution]:checked");
                const institutionName = institutionChecked.parentElement.querySelector(".title");
                institution.innerText = institutionName.innerText;
